...
from noronha.bay.goods import FlaskApp
from noronha.bay.trader import GunicornServer
...
class SimpleMarket(ABC):

    def __init__(self, predict_func, extra_routes=None, extra_confs=None):
        assert callable(predict_func), MisusageError("predict_func must be callable")
        self._predict_func = predict_func
        self.apis = join_dicts(dict(predict=predict_func), extra_routes)
